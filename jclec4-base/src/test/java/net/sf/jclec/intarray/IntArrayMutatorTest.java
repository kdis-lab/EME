...
public abstract class IntArrayMutatorTest<M extends IntArrayMutator> extends IMutatorTest<M> 
{
	public IntArrayMutatorTest(Class<M> toolClass, String testName) 
	{
