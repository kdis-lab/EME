...
/**
 * Unit tests for TrucMutatorTest.
 * 
 * @author Amelia Zafra - Sebastian Ventura
 */

public class TruncMutatorTest extends ExprTreeMutatorTest
{
	/////////////////////////////////////////////////////////////////
	// ------------------------------------------------- Constructors
	/////////////////////////////////////////////////////////////////
	...
	public TruncMutatorTest(String name) 
	{
		super(name);
	}
	...
	{
		tool.setBaseOp(new TruncMutator());		
	}
