...
/**
 * Unit tests for UnRecurseMutatorTest.
 * 
 * @author Amelia Zafra 
 * @author Sebastian Ventura 
 */

public class UnRecurseNTMutatorTests extends SyntaxTreeMutatorTest
{	
	/////////////////////////////////////////////////////////////////
	// ------------------------------------------------- Constructors
	/////////////////////////////////////////////////////////////////
	...
	public UnRecurseNTMutatorTests(String name) 
	{
		super(name);
	}
	...
	{
		tool.setBaseOp(new UnRecurseNTMutator());
	}
