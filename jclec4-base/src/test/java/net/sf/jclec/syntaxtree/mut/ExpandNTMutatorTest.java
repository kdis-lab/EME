...
/**
 * Unit tests for ExpandNTMutatorTest.
 * 
 * @author Amelia Zafra 
 * @author Sebastian Ventura
 */

public class ExpandNTMutatorTest extends SyntaxTreeMutatorTest
{	
	/////////////////////////////////////////////////////////////////
	// ------------------------------------------------- Constructors
	/////////////////////////////////////////////////////////////////
	...
	public ExpandNTMutatorTest(String name) 
	{
		super(name);
	}
	...
	{
		tool.setBaseOp(new ExpandNTMutator());
	}
