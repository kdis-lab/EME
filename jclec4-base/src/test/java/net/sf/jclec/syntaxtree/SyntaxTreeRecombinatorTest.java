...
/**
 * Unit tests for all SyntaxTreeRecombinator subclasses
 *  
 * @author Amelia Zafra
 * @author Sebastian Ventura
 */

public abstract class SyntaxTreeRecombinatorTest extends IRecombinatorTest<SyntaxTreeRecombinator> 
{
	/////////////////////////////////////////////////////////////////
	// ------------------------------------------------- Constructors
	/////////////////////////////////////////////////////////////////
	...
	public SyntaxTreeRecombinatorTest(String testName) 
	{
		super(SyntaxTreeRecombinator.class, testName);
	}
	...
	protected ISystem createContext() {
		...
		randGenFactory.setDummySequence
			(new double [] {0.1, 0.4, 0.5, 0.7, 0.9});
