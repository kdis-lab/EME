...
/**
 * Unit tests for ReduceNTMutatorTest.
 * 
 * @author Sebastian Ventura
 * @author Amelia Zafra 
 */

public class ReduceNTMutatorTest extends SyntaxTreeMutatorTest
{
	/////////////////////////////////////////////////////////////////
	// ------------------------------------------------- Constructors
	/////////////////////////////////////////////////////////////////
	...
	public ReduceNTMutatorTest(String name) 
	{
		super(name);
	}
	...
	{
		tool.setBaseOp(new ReduceNTMutator());
	}
