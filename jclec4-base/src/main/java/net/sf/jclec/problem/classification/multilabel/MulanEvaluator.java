...
/**
 * MulanEvaluator - responsible for generating evaluation data
 * 
 * @author rofr
...
public class MulanEvaluator {
    ...
    public Evaluation evaluateEME(EnsembleClassifier learner, MultiLabelInstances mlTestData,
            List<Measure> measures) throws Exception {
        checkLearner(learner);
        checkData(mlTestData);
        checkMeasures(measures);
    ...
    private List<Measure> prepareMeasures(MultiLabelLearner learner,
        ...
        try {
            ...
            Logger.getLogger(MulanEvaluator.class.getName()).log(Level.SEVERE, null, ex);
        }
