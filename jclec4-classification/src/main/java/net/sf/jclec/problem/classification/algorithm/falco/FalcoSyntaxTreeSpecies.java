...
/**
 * Species for Falco et al.- Discovering interesting classification rules with genetic programming<p/>
 * 
...
public class FalcoSyntaxTreeSpecies extends SyntaxTreeSpecies
{
	/////////////////////////////////////////////////////////////////z
	...
	protected List<NonTerminalNode> setNonTerminalSymbols(List<IAttribute> inputAttributes)
	{
		...
		nonTerminals.add(new NonTerminalNode("antecedent", new String [] {"OR", "antecedent", "antecedent"}));
		nonTerminals.add(new NonTerminalNode("antecedent", new String [] {"AND", "antecedent", "antecedent"}));
