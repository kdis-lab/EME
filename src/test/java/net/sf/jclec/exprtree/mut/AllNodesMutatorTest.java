...
/**
 * Unit tests for AllNodesMutatorTest.
 * 
 * @author Amelia Zafra - Sebastian Ventura
 */

public class AllNodesMutatorTest extends ExprTreeMutatorTest 
{
	/////////////////////////////////////////////////////////////////
	// ------------------------------------------------- Constructors
	/////////////////////////////////////////////////////////////////
	...
	public AllNodesMutatorTest(String name) 
	{
		super(name);
	}
	...
	{
		tool.setBaseOp(new AllNodesMutator());
	}
