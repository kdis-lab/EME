...
public class Evaluator {
    ...
    public MultipleEvaluation crossValidate(MultiLabelLearner learner, MultiLabelInstances data,
            int someFolds, Hashtable<String, MultiLabelLearner> tableClassifiers) {
        checkLearner(learner);
        checkData(data);
        checkFolds(someFolds);

        return innerCrossValidate(learner, data, false, null, someFolds, tableClassifiers);
    }
     ...
     */
    public MultipleEvaluation crossValidate(MultiLabelLearner learner, MultiLabelInstances data,
            List<Measure> measures, int someFolds, Hashtable<String, MultiLabelLearner> tableClassifiers) {
        checkLearner(learner);
        checkData(data);
        checkMeasures(measures);

        return innerCrossValidate(learner, data, true, measures, someFolds, tableClassifiers);
    }

    private MultipleEvaluation innerCrossValidate(MultiLabelLearner learner,
            MultiLabelInstances data, boolean hasMeasures, List<Measure> measures, int someFolds, Hashtable<String, MultiLabelLearner> tableClassifiers) {
